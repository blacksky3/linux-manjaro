...
Linux kernel build for Archlinux with Manjaro patches (Bootsplash support) with Piotr Górski Arch, Block and CPU patches, XanMod CPU Power patches and Graysky2 kernel_compiler_patch patch.
